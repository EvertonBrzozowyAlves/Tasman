...
using Tasman.Domain.API.EventStore;
...
public class TaskTypesController(WriteDbContext writeDbContext/*, EventStoreClient eventStoreClient*/) : ControllerBase
{
    ...
    public async Task<IActionResult> UpdateTaskType([FromRoute] Guid taskTypeId, [FromBody] UpdateTaskTypeRequest request)
    {
        ...
        var taskTypeNameUpdatedEvent = new TaskTypeNameUpdatedEvent
        {
            Id = taskType.Id,
